  ...
  return (
    <div className="w-[375px] h-[812px] bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col relative overflow-hidden mx-auto rounded-[25px] shadow-2xl">
      ...
      <div className="pt-16 px-6 pb-8">
        ...
        <p className="text-slate-600">Join thousands of students finding their perfect college</p>
      </div>
      ...
      <div className="flex-1 px-6">
        <div className="space-y-6">
          ...
          <p className="text-center text-slate-600">
            ...
            <button onClick={() => onNavigate("signin")} className="text-blue-600 font-semibold hover:underline">
              Sign In
            </button>
          </p>
        </div>
